...
class Window(QWidget):
    ...
    def gear_logic(self, start_time):
        ...
        current_acceleration = (throttle_percentage / 100) * max_acceleration_rate
        ...
        #!IF THE CURRENT SPEED IS IN RANGE(1, 45), SHOW ACTIVE GEAR(1).
             ...
             self.gear_indicator.setText('Current gear is: {}'.format(shifting_gears[0]['gear']))  
        ...
        #!IF THE CURRENT SPEED IS IN RANGE(46, 75), SHOW ACTIVE GEAR(2).
             ...
             self.gear_indicator.setText('Current gear is: {}'.format(shifting_gears[1]['gear']))
        ...
        #!IF THE CURRENT SPEED IS IN RANGE(76, 110), SHOW ACTIVE GEAR(3).
             ...
             self.gear_indicator.setText('Current gear is: {}'.format(shifting_gears[2]['gear'])) 
        ...
        #!IF THE CURRENT SPEED IS IN RANGE(111, 150), SHOW ACTIVE GEAR(4).
             ...
             self.gear_indicator.setText('Current gear is: {}'.format(shifting_gears[3]['gear']))
        ...
        #!IF THE CURRENT SPEED IS IN RANGE(151, 260), SHOW ACTIVE GEAR(5).
             ...
             self.gear_indicator.setText('Current gear is: {}'.format(shifting_gears[4]['gear']))
        ...
        #!IF THE CURRENT SPEED IS IN RANGE(261, 320), SHOW ACTIVE GEAR(6).
             ...
             self.gear_indicator.setText('Current gear is: {}'.format(shifting_gears[5]['gear'])) 
